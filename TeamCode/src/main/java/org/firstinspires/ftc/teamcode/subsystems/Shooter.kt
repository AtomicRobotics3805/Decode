...
//    val stop = InstantCommand { controller.goal = KineticState() }
    ...
    val start = RunToVelocity(controller, (6000 / 60.0) * ticksPerRev, KineticState(Double.POSITIVE_INFINITY, 500.0, Double.POSITIVE_INFINITY)).requires(this) // (desired RPM / 60) * ticks per rev
