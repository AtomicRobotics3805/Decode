...
@Autonomous(name = "\uD83D\uDFE5 Goal NINE Dump After First Red", group = "NINE DUMP", preselectTeleOp = "Competition TeleOp")
class GoalStartDumpAfterFirstRed : NextFTCOpMode() {
...
//    lateinit var follower: Follower
    ...
    override fun onStartButtonPressed() {
        AutoRoutinesV2.goalStartNineDumpFirst()
    }
