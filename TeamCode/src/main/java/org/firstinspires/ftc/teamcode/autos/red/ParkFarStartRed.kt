...
@Autonomous(name = "\uD83D\uDFE5 Far Start Park", group = "PARK", preselectTeleOp = "Competition TeleOp")
class ParkFarStartRed : NextFTCOpMode() {
...
//    lateinit var follower: Follower
    ...
    override fun onInit() {
        ...
        PedroComponent.Companion.follower.setStartingPose(TrajectoryFactoryAtInterleague.farStartPos.mirror())
        Drawing.init()
    ...
    override fun onStartButtonPressed() {
        AutoRoutines.farParkAutoRoutine()
    }
