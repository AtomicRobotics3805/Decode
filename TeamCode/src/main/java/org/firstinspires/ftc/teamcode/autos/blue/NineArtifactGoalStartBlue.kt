...
@Autonomous(name = "\uD83D\uDFE6 Goal Start NINE Blue", group = "NINE", preselectTeleOp = "Competition TeleOp")
class NineArtifactGoalStartBlue : NextFTCOpMode() {
